...
//USADO PARA O JOGADOR RETORNAR PRA ROOM

if (place_meeting(x, y, obj_player)) {
    if (obj_player.tem_chave && global.tem_chave_incremento == 1 ||  global.tem_chave_incremento == 2) {
        if (room != room_last) {
            ...
            if (keyboard_check(ord("C"))) {
                ...
                proxima_sala = Room1;      // Define a próxima fase para rm_nivel2
            }
